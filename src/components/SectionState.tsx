    ...
    <div className="rounded-xl border border-study-red/20 bg-study-red/5 px-4 py-4 flex flex-col sm:flex-row sm:items-center gap-3">
      ...
      {onAction && (
        <button
          type="button"
          onClick={onAction}
          className="inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-white border border-study-lightgray text-xs font-semibold text-study-dark hover:bg-study-bg transition-colors"
        >
