  ...
  return (
    <div className="py-3">
      <div className="bg-study-card border border-study-lightgray rounded-xl overflow-hidden">
        <div className="px-4 py-3 bg-red-50 dark:bg-red-500/10 border-b border-red-100 dark:border-red-500/20">
        ...
        <div className="divide-y divide-study-lightgray">
          {items.map((item, i) => (
            <div key={i} className="flex items-start gap-3 px-4 py-2.5">
              <div className="w-5 h-5 rounded-full bg-red-50 dark:bg-red-500/10 flex items-center justify-center shrink-0 mt-0.5">
